...
export default function Sidebar({ onNavigate }: SidebarProps) {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-80px)] sticky top-20 bg-white/40 backdrop-blur-2xl border-r border-white/60 shadow-[4px_0_24px_-12px_rgba(0,0,0,0.1)] w-64 md:w-72 shrink-0 z-10">
